...
export const asyncRouterMap = [
  ...
  },
  {
    path: '/business',
    component: Layout,
    meta: { perm:'m:businessorder', title: '账单', icon: 'chart' },
    children: [
      {
        path: 'businessType_manage',
        name: 'businessType_manage',
        component: _import('_system/jack/businessType'),
        meta: { perm: 'm:businesstype:list', title: '账单类型', icon: 'chart', noCache: true }
      },
      {
        path: 'businessOrder_manage',
        name: 'businessOrder_manage',
        component: _import('_system/jack/businessOrder'),
        meta: { perm: 'm:order:perm', title: '账单', icon: 'chart', noCache: true }
...

  {
    ...
    children: [{
      ...
      meta: { perm:'m:menu1', title: '消费统计', icon: 'icon' }
    }]
  },
